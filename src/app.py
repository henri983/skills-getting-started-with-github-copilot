...
activities = {
    ...
    "Soccer Training": {
        "description": "Team-based soccer drills and strategy practice",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swimming technique, endurance, and lap training",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["liam@mergington.edu", "maya@mergington.edu"]
    },
    "Painting Workshop": {
        "description": "Explore painting techniques in watercolor and acrylic",
